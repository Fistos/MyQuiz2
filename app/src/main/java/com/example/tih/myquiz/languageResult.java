...
public class languageResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yourAnswer3 = (TextView) findViewById(R.id.scoreL);
        ...
        //Onclick Listener
        btn = (Button)findViewById(R.id.buttonq);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(languageResult.this,quiz.class);
                startActivity(i);
            }
        });
