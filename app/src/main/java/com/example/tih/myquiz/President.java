...
public class President extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    Button sbtn;
    String scoreTexts="";
    int finalscore = 0;
    ...
    public String expectedAnswer = "Nelson Mandela";
    public String expectedAnswer1 = "thabo Mbeki";
    public String expectedAnswer2 = "Jacob Zuma";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Onclick Button
        sbtn = (Button) findViewById(R.id.sbt);
        sbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                display();
                Intent in = new Intent(President.this, Result.class);
                in.putExtra("answer", answer);
                in.putExtra("answer1", answer1);
                in.putExtra("answer2", answer2);
                in.putExtra("score", finalscore);
                in.putExtra("scoreText",scoreTexts);
                startActivity(in);
                finalscore = 0;
    ...
    public void display() {
        ...
        if (answer1.equalsIgnoreCase(expectedAnswer1)) {
            finalscore += 1;
        }
